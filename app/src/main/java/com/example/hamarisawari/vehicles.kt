               ...
               _latitude: String, _longitude: String)
{
    ...
    var rentingprice = _rentingPrice
    var color = _color
    var manufacturer = _manufacturer
    var seatingCapacity = _seatingCapacity
    var transmission = _transmission
    var type = _type
    var engineCapacity = _engineCapacity
    var mileage = _mileage
    var carModel = _carModel
    var engineNumber = _engineNumber
